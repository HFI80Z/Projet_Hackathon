                ...
                <div class="p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-500">contact@votresite.com</p>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex space-x-4">
                            <a href="#" class="h-10 w-10 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 hover:bg-blue-200 transition">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden text-center">
                    ...
                    <div class="p-6">
                        ...
                        <p class="mt-2 text-gray-500 text-sm">Sophie répond à toutes vos questions avec le sourire</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden text-center">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900">Laura Petit</h3>
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden text-center">
                    ...
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900">Marc Leroy</h3>
